...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { animation: 'testimonialDetail' }
      },
      {
        path: 'testimonials',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { animation: 'adminCategories' }
      },
      {
        path: 'industries',
        ...
        data: { animation: 'adminIndustries' }
      },
      {
        path: 'gallery',
      ...
      },
      {
        ...
        data: { animation: 'adminTestimonials' }
      },
      {
        path: 'hero-slider',
        ...
        data: { animation: 'adminHeroSlider' }
      },
      {
        path: 'messages',
