      ...
      <div class="container">
        <div class="row g-5 align-items-center">
          <div class="col-lg-6">
            ...
            <p class="lead">Motors Industries designs and delivers world-class industrial equipment engineered for demanding environments.</p>
...
export class AboutPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seo.update({ title: 'About Us', description: 'Learn about Motors Industries — engineering excellence since 1999.' });
  }
}
