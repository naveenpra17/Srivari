...
const FALLBACK_TESTIMONIALS: Testimonial[] = [
  {
    ...
    company: 'Tata Steel',
    content: 'Sri Vaari delivered exceptional reliability across our production line. Their engineering support and product quality are world-class.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'We have partnered with Sri Vaari for over a decade. Their pumps consistently exceed performance benchmarks in demanding environments.',
    rating: 5,
